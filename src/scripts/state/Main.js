const Main = Wondershot.State.Main = class Main extends Phaser.State {
  ...
  create() {
      const mainMenuTitle = this.game.add.text(this.game.world.centerX, 150, 'Main Menu', { font: '42px Arial', fill: '#000' });
      mainMenuTitle.anchor.setTo(0.5, 0.5);
      const optionBattle = this.game.add.text(this.game.world.centerX, 250, 'Battle', { font: '24px Arial', fill: '#000' });
