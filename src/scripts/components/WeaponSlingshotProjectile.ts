module Wondershot.Components {
  export class WeaponSlingshotProjectile {
    ...
    static create() {
      ...
      this.projectilesPool.forEach(function(projectile) {
        ...
        projectile.body.setMaterial(CollisionManager.materials.WeaponSlingshot);
      }, this);
    }
    ...
    constructor(options) {
      ...
      projectile.body.setCollisionGroup(CollisionManager['Projectile'+owner.playerNumber].id);
      projectile.body.collides(CollisionManager['Projectile'+owner.playerNumber].World, this.worldHitHandler, this);
      projectile.body.collides(CollisionManager['Projectile'+owner.playerNumber].OtherPlayers, this.playerHitHandler, this);
