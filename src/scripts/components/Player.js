const pauseMenu = Wondershot.Components.PauseMenu,
      CollisionManager = Wondershot.Components.CollisionManager;

const Player = Wondershot.Components.Player = class Player {
    constructor(playerNumber) {
        ...
        this.sprite.body.setCollisionGroup(Components.CollisionManager['Player' + playerNumber].id);
        this.sprite.body.collides(Components.CollisionManager['Player' + playerNumber].World);
        this.sprite.body.collides(Components.CollisionManager['Player' + playerNumber].OtherProjectiles);
    }
